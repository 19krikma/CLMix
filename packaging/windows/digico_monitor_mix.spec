# PyInstaller spec for the DigicoMonitorMix desktop app.
#
...
#
# Usage: pyinstaller packaging/windows/digico_monitor_mix.spec
...
# onedir (not onefile): produces dist/DigicoMonitorMix/ as a folder of
# loose files rather than a single self-extracting exe - starts faster
# (no per-launch extraction to a temp dir) and is what installer.iss
# expects to copy wholesale into Program Files.
exe = EXE(
    pyz,
    a.scripts,
    [],
    exclude_binaries=True,
    name="DigicoMonitorMix",
    debug=False,
